...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["role_id"], ["roles.id"], name="fk_rolepermission_role", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_activation_keys_id"), "activation_keys", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_activation_keys_key"), "activation_keys", ["key"], unique=True
    )
    op.create_index(
        "ix_active_keys", "activation_keys", ["user_id", "is_active"], unique=False
    )
    op.create_index(
        "ix_key_expires", "activation_keys", ["key", "expires_at"], unique=False
    )
    op.create_table(
        "categories",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_category_active_name", "categories", ["is_active", "name"], unique=False
    )
    ...
    op.create_index(
        "ix_component_product_id", "components", ["product_id"], unique=False
    )
    op.create_table(
        "versions",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("NEW", "ASSIGNED", "FIXED", "VERIFIED", "CLOSED", name="bugstatus"),
            nullable=False,
        ),
        sa.Column(
            "priority",
            sa.Enum("LOW", "MEDIUM", "HIGH", "CRITICAL", name="bugpriority"),
            nullable=False,
        ),
        sa.Column("is_deleted", sa.Boolean(), nullable=True),
    ...
    op.create_index(
        "ix_bug_product_component", "bugs", ["product_id", "component_id"], unique=False
    )
    ...
    op.create_index(
        "ix_attachment_bug_version", "attachments", ["bug_id", "version"], unique=False
    )
    op.create_index(
        op.f("ix_attachments_filename"), "attachments", ["filename"], unique=False
    )
    op.create_table(
        "bug_tags",
        sa.Column("id", sa.Integer(), nullable=False),
